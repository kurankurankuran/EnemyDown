...
float                   CSound::m_fVolumeValue;
float                   CSound::m_fMaxVolume;
float                   CSound::m_fMaxSizeXBar;
...
void CSound::Init(void)
{
	...
	m_fVolumeValue = g_fVolume_Value;
	m_fMaxVolume = g_fMaxVolume;
	m_fMaxSizeXBar = g_fMaxSizeX_Bar;

	CSound::SetVolume(0.2f);
	CSound::SetVolumeBGM(0.3f);
	CSound::SetVolumeSE(0.3f);
}
