...
private:
	...
	static float                    m_fVolumeValue;
	static float                    m_fMaxVolume;
	static float                    m_fMaxSizeXBar;
public:
	CSound(void);
	virtual ~CSound(void);
	...
	static float GetVolumeValue() { return m_fVolumeValue; }
	static float GetMaxVolume() { return m_fMaxVolume; }
	static float GetMaxBarSizeX() { return m_fMaxSizeXBar; }
};